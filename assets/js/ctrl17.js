...
	$scope.jobseekers = [       {id : "1" , picture : "https://myevent.com/assets/myevent/common/img/user.png" , name : "حمید محمدی", tag : "کارشناس", status : "پیام داده شد", date : "امروز", sendmass : "", viewprofile : "", downloadprofile : "", reqtype : "ارزیابی شایستگی", testtype : "بسته شایستگی عمومی",},        {id : "2" , picture : "https://myevent.com/assets/myevent/common/img/user.png" , name : "اصغر صفی علیشاه", tag : "کارشناس", status : "جدید", date : "امروز", sendmass : "", viewprofile : "", downloadprofile : "", reqtype : "گواهینامه", testtype : "زبان انگلیسی",},        {id : "3" , picture : "https://myevent.com/assets/myevent/common/img/user.png" , name : "محمدرضا تقی زاد مژگان", tag : "کارشناس", status : "جدید", date : "امروز", sendmass : "", viewprofile : "", downloadprofile : "", reqtype : "درخواست دوره", testtype : "ویژال استودیو",},        {id : "4" , picture : "https://myevent.com/assets/myevent/common/img/user.png" , name : "رئیس علی نادر کلابادی", tag : "کارشناس", status : "جدید", date : "امروز", sendmass : "", viewprofile : "", downloadprofile : "", reqtype : "درخواست تعﯿﯿن سطح", testtype : "زبان انگلیسی",},       ];		    $scope.jobseekersviewby = 8;  $scope.jobseekerstotalItems = $scope.jobseekers.length;  $scope.jobseekerscurrentPage = 1;  $scope.jobseekersitemsPerPage = $scope.jobseekersviewby;  $scope.jobseekersmaxSize = 5;  $scope.gotomailpage = function (jobseeker) {        $scope.composeEmail = {};        $scope.activeTab = "compose";        $scope.activeTabF = "tab4";		$scope.composeEmail.to = jobseeker.id;		$scope.isreceiveVisible = false;  };     $scope.downloadattach = function (jobseeker) {    window.open(jobseeker, '_blank', '');    };      $scope.taiid = function (jobseeker) {	$("#ShowPopupTaiid").modal('show');  };        $scope.sendfactor = function(jobseeker) {     if (confirm("ایا اطمینان دارید؟")) {	alert("فاکتور ارسال شد");    }  };         $scope.adamtaiid = function(jobseeker) {     if (confirm("ایا اطمینان دارید؟")) {			alert("کاربر رد شد");    }  };    $scope.jobseekerssetPage = function (pageNo) {    $scope.jobseekerscurrentPage = pageNo;  };$scope.setItemsPerPage = function(num) {  $scope.itemsPerPage = num;  $scope.currentPage = 1; }
