...
'</svg>'
	...
			            $scope.getservice = function() {                var config = {                        headers: {                            'Content-Type': 'application/json',                            'Access-Token': $localStorage.TokenKey.access,                        }                 }                $http.get(mustafasite + '/employer/service', JSON.stringify(data), config).then(function(response) {						$scope.productsandservices = response.data.services;				}); 				}	       				$scope.getservice();									            $scope.getourbrand = function() {                var config = {                        headers: {                            'Content-Type': 'application/json',                            'Access-Token': $localStorage.TokenKey.access,                        }                 }                $http.get(mustafasite + '/employer/my_logos', JSON.stringify(data), config).then(function(response) {						$scope.ourbrands = response.data.logos;				    }); 				}	       				$scope.getourbrand();				
