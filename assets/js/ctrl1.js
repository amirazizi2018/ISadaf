...
app.controller('mainpage', function($compile, $sce, $scope, $window, $http, ShareData, $location, $localStorage, $sessionStorage,SweetAlert) {
  ...
  $scope.banners = [
    {
      ...
      text: 'پروفایل شغلی نخستین تصویر از شما در دیدگان کارفرماست. با ایجاد یک پروفایل شغلی هدفمند، جامع و شفاف تصویری جذاب از خود در ذهن کارفرما ایجاد نمائید. صدف برای آن انواع امکانات را در اختیار شما قرارداده است.',
    },
    {
      title: 'انجام پژوهش برای صنعت توسط شما',
      img: 'assets/images/three-home2.svg',
      text: 'مسائل بسیار زیادی در صنابع مختلف، در انتظار راه حل های شما هستند. شما می تواند با دانش، مهارت و تجربه خود با حل مسائل بیان شده در صدف همکاری خود را با انواع صنایع آغاز نمائید.',
    },
    {
      title: 'معرفی شما به عنوان نیروی کار',
      img: 'assets/images/three-home3.svg',
      text: 'بهترین نیروی کار برای بهترین جایگاه شغلی. این شعار صدف در معرفی سرمایه انسانی به صنعت است. در سامانه صدف مجموعه ای از بهترین ابزارها برای بهترین انتخاب ها در اختیار شما قرار دارد.',
    },
  ];
  ...
  $scope.Searchmahratfun = function(searchmaharat) {
    ...
    SweetAlert.swal({
     title: "کاربر گرامی!",
     text: "برای استفاده از سرویس های سامانه صدف لازم است ثبت نام نموده و یا به حساب کاربری خود وارد شوید.",
     type: "error",
     showCancelButton: false,
     confirmButtonColor: "#DD6B55",
     confirmButtonText: "بازگشت",
