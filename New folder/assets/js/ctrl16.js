...
app.controller('spprofilepage' ,function($compile, $sce, $scope, $window, $http, Upload, $timeout) {
...
$scope.ourteam.some(function(obj, i) {
  return obj.id == person.id ? index = i : false;
});

  $scope.ourteam.splice($scope.ourteam.indexOf(person), 1);
        }
    }
